                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("\$0 Balance",style: TextStyle(color: Colors.white,fontSize: 14),),
                      ),
                      Padding(
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Column(
                                    children: [
                                      Text(authController.user!.value.email,style: TextStyle(color: Colors.white),),
                                    ],
                                  ),
                                ],
                              ),
                ...
                ListTile(
                 ...
                 InkWell(
                  onTap: (){
                   ...
                   child: ListTile(
                    leading: Image.asset(
                      "assets/ror.png",color: Color.fromARGB(255, 56, 171, 216),
                      height: 20,
                      width: 20,
                    ),
                    title: Text("Wallets"),
